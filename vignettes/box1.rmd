...
In the conservation planner's case, EVPI is $0.8 - 0.6 = \mathbf{0.2}$, meaning that if they could express habitat value as money, they should be willing to spend up to 20% of the price of a property, but no more, on learning about habitat suitabilty, before they decide what to protect, because if the expense of gathering the information is greater than the expected benefit from acting on the accumulated information(new information plus original).
