```{r plot_evwoi_bin_example, fig.cap = caption_evwoi_bin_example,  fig.width = 7.5, fig.height = 5}
...
```{r plot_evwpi_bin_example, fig.cap = caption_evwpi_bin_example, fig.width = 7.5, fig.height = 5}
