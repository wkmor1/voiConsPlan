...
Finally we arrive at the EVPI, which is simply the difference between EVWPI and EVWOI. Here EVPI is `r fmt((evwpi - evwoi) * 100)`. This is the increase in performance we would expect to see on average if we learned everything there was to know about the distribution of the species of conservation concern in our conservatino plan. To express this value in different terms, if we consider a species with acarrying capacity of 1 individual per km^$2$ and that species had a total carrying capacity in the Hunter of XXXX individuals, inacting a conservation plan with the information at hand (based on 30 observations) we would expect (on average) to preserve enough habitat to accomodate XXXX individuals. Were we to enact a plan with complete certainty the we would expect to preserve enough habitat (though the same size of area) to accomodate XXXX more individuals.
